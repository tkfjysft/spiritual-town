...
export const townNewsData: TownNewsData = {
  ...
  "items": [
	{
      "date": "2026/8/9",
      "name": "「ルナ宵町」様にご登録いただきました。",
	  "siteName": "ルナ宵町",
      "description": "ココナラで活動する占い師の口コミを、鑑定動画つきで比較できるようにまとめている情報メディアです。 実際の鑑定動画から話し方や雰囲気を確認できるため、「相性が合わなかった」というミスマッチを減らせます。 復縁・彼の気持ち・音信不通・複雑な恋のご相談先を探している方に向けて、7問の無料診断や相性占いもご用意しています。",
      "image": "/thum/uranai-luna.com.avif",
